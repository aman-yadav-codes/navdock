    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] transition-colors duration-300">
      ...
      <div className="page-content pb-36" id="pageContent">
        ...
        <div className="hero">
          ...
          <div className="edubird-search-wrapper mt-5 max-w-xl mx-auto">
          ...
          <button 
            className="edubird-btn max-w-xl mx-auto block"
            onClick={() => {
              // Trigger search mock
            ...
            <div className="section-card mb-0">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <div className="flex items-center gap-3 p-2.5 rounded-xl bg-[rgba(255,255,255,0.02)]">
                  ...
                  <div className="text-left">
                    <div className="text-[13px] font-semibold text-[var(--text-primary)]">Swipe Up or Drag Mouse Up</div>
                    <div className="text-[11px] text-[var(--text-muted)]">Expands dock using handle</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2.5 rounded-xl bg-[rgba(255,255,255,0.02)]">
                  <div className="w-9 h-9 rounded-lg bg-[rgba(var(--accent-rgb),0.1)] flex items-center justify-center">
                  ...
                  <div className="text-left">
                    <div className="text-[13px] font-semibold text-[var(--text-primary)]">Swipe Down or Drag Mouse Down</div>
                    <div className="text-[11px] text-[var(--text-muted)]">Collapses dock using handle</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2.5 rounded-xl bg-[rgba(255,255,255,0.02)]">
                  <div className="w-9 h-9 rounded-lg bg-[rgba(var(--accent-rgb),0.1)] flex items-center justify-center">
